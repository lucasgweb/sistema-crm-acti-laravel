...
@section('content')
    ...
    <x-modal title="Detalles" action="{{ route('teacher.store') }}" id="modalNew">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="inputRemuneration" type="text" placeholder="Ingresar pago/hora" name="remuneration">
        </div>
        <div class="mb-3">
    ...
    <x-modal title="Editar" action="{{ route('teacher.update') }}" id="modalEdit">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="getRemuneration" type="text" placeholder="Ingresar pago/hora" name="remuneration">
        </div>
        <div class="mb-3">
            <label class="small mb-1">Curso:</label>
            <select class="form-select" name="course_id">
