...
@section('content')
    ...
    @cannot('Usuario')
        ...
        <x-modal title="Detalles del Alumno" action="{{ route('student.store') }}" id="modalNew">
        ...
        <x-modal title="Editar Alumno" action="{{ route('student.update') }}" id="modalEdit">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-3">
                        <label class="small mb-1">Curso:</label>
                        <select class="form-select" name="course_id">
                            <option id="getCourse">Seleccione el Curso:</option>
                            @foreach ($courses as $course)
                                <option value="{{ $course->id }}">{{ $course->name }}</option>
                            @endforeach
                        </select>
