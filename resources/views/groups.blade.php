...
@section('content')
    ...
    <x-modal title="Detalles" action="{{ route('group.store') }}" id="modalNew">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input class="form-control" id="getName" type="text" placeholder="Ingresar denominación" name="name"
                        required>
                </div>
            </div>
            <div class="col-sm-6">
    ...
    <x-modal title="Editar" action="{{ route('group.update') }}" id="modalEdit">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-3">
                    <label class="small mb-1" for="inputEditName">Denominación:</label>
                    <input class="form-control" id="getName" type="text" placeholder="Ingresar denominación"
                        name="name" required>
                </div>
            </div>
            <div class="col-sm-6">
